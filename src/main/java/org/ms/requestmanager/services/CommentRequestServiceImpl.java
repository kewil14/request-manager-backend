...
public class CommentRequestServiceImpl implements CommentRequestService {
    ...
    public CommentRequestServiceImpl(CommentRequestRepository commentRequestRepository, CommentRequestMapper commentRequestMapper, RequestRepository requestRepository, PersonalRepository personalRepository) {
